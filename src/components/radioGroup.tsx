        ...
        <Radio
            ...
            classNames={{
                base: cn(
                    ...
                    "data-[selected=true]:border-secondary border-default justify-center text-center data-[selected=true]:bg-violet-100 data-[selected=true]:dark:bg-violet-800/20",
                ),
                wrapper: "hidden",
            ...
            <div className="flex flex-row gap-4 w-full">
                <CustomRadio description="Es un evento o un taller" value="Evento" className="flex-1" >
                    <div className="flex flex-col justify-center items-center gap-1">
                        {value !== "Evento" ? <EventIcon size={24} color="bg-secondary" /> : <EventFilledIcon size={24} />}
                        <p>
                            Evento
                        </p>
                    </div>
                ...
                <CustomRadio description="Contiene varios eventos" value="Calendario" className="flex-1" >
                    <div className="flex flex-col justify-center items-center gap-1">
                        {value !== "Calendario" ? <CalendarIcon size={24} color="bg-secondary" /> : <CalendarFilledIcon size={24} />}
                        <p>
                            Calendario
                        </p>
                    </div>
